...
| AC105.12 | Each of the four cases has its own test, named for the case it covers | `pytest automation/issue_validator_test.py -k label_pair -v` lists four tests, all passing — the three above plus the milestone-with-a-pair-label case |
