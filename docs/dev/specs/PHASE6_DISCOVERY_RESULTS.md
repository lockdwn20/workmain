...
--- EVENT ---
  ...
  SEQUENCE: 0
  SUMMARY: vText(b'Copy: ACME Daily touchpoint')
...
--- EVENT ---
  ...
  SEQUENCE: 0
  SUMMARY: vText(b'Copy: ACME - Policy Violation Weekly touchpoint')
  TRANSP: vText(b'OPAQUE')
...
--- EVENT ---
  ...
  SEQUENCE: 0
  SUMMARY: vText(b'Copy: All ACME - Biweekly Projects')
  TRANSP: vText(b'OPAQUE')
...
--- EVENT ---
  ...
  SEQUENCE: 0
  SUMMARY: vText(b'Copy: All ACME - Biweekly Cases / Investigations')
  TRANSP: vText(b'OPAQUE')
...
--- EVENT ---
  ...
  SEQUENCE: 0
  SUMMARY: vText(b'Copy: Splunk Follow Up: ACME and EXAMPLECO ')
  TRANSP: vText(b'OPAQUE')
...
--- EVENT ---
  ...
  SEQUENCE: 0
  SUMMARY: vText(b'Copy: Monthly - ACME - Alert discussion')
  TRANSP: vText(b'OPAQUE')
