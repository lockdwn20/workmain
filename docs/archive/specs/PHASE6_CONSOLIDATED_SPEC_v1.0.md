...
- [ ] Recipients add/remove/list working
- [ ] Assign/unassign working
- [ ] Draft generation pulls correct recipients from DB
- [ ] `save` writes file to `~/.workmain/drafts/` at chmod 600
...
- [ ] `CHANGELOG.md` updated noting original OAuth scope and ICS path rationale
...
workmain email assign 1 daily to
workmain email daily preview
workmain email daily save
```

---

*Phase 6 Consolidated Spec v1.0 — Planning complete. Ready for Claude Code.*
